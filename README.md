# @hishprorg/voluptate-molestiae-nostrum
...
__Motto of `@hishprorg/voluptate-molestiae-nostrum` is simple__: *create the smallest possible CSS-in-JS library and provide all features of any other library through addons.*

- __Only [0.5 Kb](https://bundlephobia.com/result?p=@hishprorg/voluptate-molestiae-nostrum@1.15.3)__ in base configuration, *e.g. [`styled-components`](https://github.com/styled-components/styled-components) is [15.1Kb](https://bundlephobia.com/result?p=styled-components@3.2.5)*
...
> For pre-configured simple-to-use package see [`nano-theme`](https://github.com/streamich/nano-theme), which builds on top of `@hishprorg/voluptate-molestiae-nostrum`.
...
[npm-url]: https://www.npmjs.com/package/@hishprorg/voluptate-molestiae-nostrum
[npm-badge]: https://img.shields.io/npm/v/@hishprorg/voluptate-molestiae-nostrum.svg
[travis-url]: https://travis-ci.org/streamich/@hishprorg/voluptate-molestiae-nostrum
[travis-badge]: https://travis-ci.org/streamich/@hishprorg/voluptate-molestiae-nostrum.svg?branch=master
